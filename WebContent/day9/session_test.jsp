...
<div>http 프로토콜은 stateless(상태정보유지안됨), 비연결 <br>
	  ...
	  -> request 를 통해서 브라우저의 세션 ID 가 부여되고 그 값으로 구별. <br>
	  -> 로그인 기능 구현에 활용합니다. <br>
	  -> 톰캣은 JSESSIONID 값을 만듭니다. <br>
...
<%
	...
	out.print("세션 생성시간 long : " + start);		// 시간이 long 일 때는 1970년 1월 1일을 시작으로 ms 단위
	out.print("<br>");
	...
	out.print("<br>");
//	session.setMaxInactiveInterval(60);		// web.xml 변경하고 실행할 때는 주석 처리 하세요.
	// 마지막 session 접근 시간
